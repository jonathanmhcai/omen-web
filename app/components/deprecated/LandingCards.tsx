...
/**
 * DEPRECATED — the former landing page, kept for reference after the daily
 * brief took over `/` (2026-08-11). Not routed and not imported anywhere.
 *
 * A stacked list of entry-point cards: the daily brief, the signals feed
 * (`/stories`), the trader directory (`/traders`), and the mobile app.
 */
const ENTRIES = [
  {
    href: "/",

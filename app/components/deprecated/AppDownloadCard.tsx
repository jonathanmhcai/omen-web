...
/**
 * DEPRECATED — the App Store download card, replaced (2026-08-12) by a
 * waitlist card matching omen-website's hero. Kept intact for when the app
 * is open to everyone and a direct download link makes sense again. Not
 * imported anywhere.
 *
